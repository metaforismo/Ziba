...
Benvenuto in synapsium. Questo vault di esempio dimostra le funzionalità principali:

- Apri una nota dalla sidebar (es. [[Idee]]).
- Le wikilink ti portano in giro: [[Progetti/synapsium]] è la nota su questo progetto.
...
- [[Progetti/synapsium]] — un second brain locale + Notion + Obsidian.
...
In sviluppo, v0.1. Vedi il [README](https://github.com/metaforismo/Synapsium) sul repo.
...
Ha contribuito a [[Progetti/synapsium]] facendo testing iniziale. Mi ha consigliato [[Libri/Sapiens]] dopo una conversazione su rappresentazioni della conoscenza.
`,
  },
  {
...
- Rilevante per [[Progetti/synapsium]]: i second brain sono fiction utili
...
- Provato [[Progetti/synapsium]] per la prima volta. Funziona la cattura veloce con \`[[\`.
...
async function main() {
  ...
  console.log('');
  console.log('Apri questa cartella in synapsium dal pulsante "Apri vault".');
